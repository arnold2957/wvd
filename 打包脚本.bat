...
:: 打包并添加时间戳到文件名
:: pyinstaller --onefile --add-data "resources/images;resources/images/" src/gui.py -n wvd-%timestamp%
pyinstaller --onedir --noconsole --add-data "resources/images;resources/images/" src/gui.py -n wvd-%timestamp%
