...
注意:
因为我的游侠等级不够, 现在征求一张游戏内乱射技能的截图.

**已知问题**
开箱极速版.
mark_auto其实有一个不能覆盖的问题 就是在雪里 那个markauto是点不了的 我建议改成点过一次markauto之后后续点那个resume 只有resume是可以在雪里点的 而且这俩本质上没区别
新增一个选项跳跃到四章结局吧，蝎女可以好刷很多哦
我觉得该把“再起后恢复”放在gui，让人能看见知道 即便是强制开启，无法修改
他们活了前加入一次截图
